...
import com.duplicatefinder.data.repository.OverlayCleaningModelRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindOverlayCleaningModelRepository(
        impl: OverlayCleaningModelRepositoryImpl
